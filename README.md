...
- **모델은 둘이다.** 백엔드 노동은 Daybreak Blue(`gpt-daybreak-blue`), 화면과 i18n과 가장 어려운 문제는 ASTRA(`gpt-6-astra`, GPT-6 Astra, 2026-09-03 공개, 슬러그 2026-09-05 실측 확인). effort는 `high`가 기본이고 절망적으로 어려운 문제에만 `max`를 쓴다.
